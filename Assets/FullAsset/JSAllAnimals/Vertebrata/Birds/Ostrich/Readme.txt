Thank you for downloading Ostrich.

This is a semi realistic 3d model and animations of an Ostrich. 
-Models folder contains OstrichModel.FBX and OstrichModelTwoLODs.FBX.
...
Demo folder contains an example use of the Ostrich model. 

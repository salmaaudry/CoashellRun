...
public class OstrichCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject ostrichCamera;
	...
	void Update(){
		...
		ostrichCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}

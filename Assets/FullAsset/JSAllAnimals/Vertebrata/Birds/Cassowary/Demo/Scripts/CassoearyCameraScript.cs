...
public class CassoearyCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject cassowaryCamera;
	...
	void Update(){
		...
		cassowaryCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}

...
public class AlligatorSnappingTurtleCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject alligatorSnappingTurtleCamera;
	...
	void Update(){
		...
		alligatorSnappingTurtleCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}

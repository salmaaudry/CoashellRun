...
public class RedFootedTortoiseCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject tortoiseCamera;
	...
	void Update(){
		...
		tortoiseCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}

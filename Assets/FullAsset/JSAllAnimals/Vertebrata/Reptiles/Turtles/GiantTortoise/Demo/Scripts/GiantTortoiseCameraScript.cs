...
public class GiantTortoiseCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject giantTortoiseCamera;
	...
	void Update(){
		...
		giantTortoiseCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
